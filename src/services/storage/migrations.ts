...
const DEFAULT_SETTINGS_STORAGE_KEY = STORAGE_KEYS.SETTINGS_STORAGE;
const DEFAULT_CHAT_STORAGE_KEY = STORAGE_KEYS.CHAT_STORAGE;
const DEFAULT_MIGRATION_MARKER_KEY = STORAGE_KEYS.MIGRATION_MARKER_V1;
